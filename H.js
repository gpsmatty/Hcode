!function(e) {
    ...
    (function(e) {
        ...
        e.Draft = c.default,
        e.hemingwayStore = (0,
        u.createStore)(h.default),
        a.default.render(o.default.createElement(s.Provider, {
            store: e.hemingwayStore
        }, o.default.createElement(f.default, null)), document.getElementById("hemingway")),
...
, function(e, t, n) {
    ...
    function o(e) {
        var t = T(e)
          ...
          , r = n.getDepth();
        if (0 === r)
            return y.RichUtils.toggleBlockType(e, "unstyled");
    ...
    function s(e, t, n) {
        var r = y.DefaultDraftBlockRenderMap.set("p", {
          ...
          , o = (0,
        y.convertFromHTML)(n, y.getSafeBodyFromHTML, r).map(function(e) {
    ...
    t.createEditorState = v.default.pipe(y.ContentState.createFromText, y.EditorState.createWithContent),
    t.createEmptyEditorState = y.EditorState.createEmpty,
    t.getText = v.default.pipe(S, v.default.invoker(0, "getPlainText"))
}
, function(e, t) {
    e.exports = Draft
}
      ...
      , c = function(e) {
        function t(e) {
            ...
            return n.onToggle = function(e) {
                e.preventDefault(),
                n.props.onToggle(n.props.styleName)
            }
            ,
            n
        }
        ...
        u(t, [{
            ...
            value: function() {
                ...
                return this.props.active && (e += " hemingway-richtext-active-button"),
...
, function(e, t, n) {
    ...
    var o = n(4)
      ...
      , c = r(l)
      , d = (0,
    o.pipe)(a.default.parse.bind(a.default), s.default.score.bind(s.default), c.default.highlight.bind(c.default))
      , f = {
        run: d
    };
    t.default = f
...
, function(e, t, n) {
    ...
    var o = n(2)
      ...
      , s = {
        score: function(e) {
            return this.scoreSentences(e),
            this.scoreWholeTree(e),
            this.scoreHighlightTotals(e),
            e
        },
        ...
        scoreHighlightTotals: function(e) {
            ...
            e.stats.highlights = u.default.getSentences(e).reduce(function(e, n) {
                var r = n.tokens;
                return e.adverbs += t.countTokensOfType(r, i.default.tokens.adverb) + t.countTokensOfType(r, i.default.tokens.qualifier) + t.countTokensOfType(r, i.default.tokens.vaguePhrase),
                e.passiveVoices += t.countTokensOfType(r, i.default.tokens.passiveVoice),
                e.complexWords += t.countTokensOfType(r, i.default.tokens.complexWord) + t.countTokensOfType(r, i.default.tokens.buzzword) + t.countTokensOfType(r, i.default.tokens.cliche),
    ...
    var u = function() {
      ...
      , h = function(e) {
        function t(e) {
            o(this, t);
            var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
            return n.initialEditorState = (0,
            f.default)(n.props.trackBlock),
        ...
        u(t, [{
            ...
            value: function() {
                (0,
                p.trackLastBlockAfterSplit)(this.props.editorState, this.props.trackBlock),
                this.props.showURLInput || this.focusEditor()
            }
        }, {
            key: "onTab",
            value: function(e) {
                return this.props.onTab(this.props.editorState, e),
                !0
            }
        }, {
            key: "bindKeys",
            value: function(e) {
                var t = c.KeyBindingUtil.hasCommandModifier
                  , n = t(e);
                return 74 === e.keyCode && n ? "write-edit" : 75 === e.keyCode && n ? "show-url-input" : 13 === e.keyCode && (0,
                p.isOnEmptyListItem)(this.props.editorState) ? "decrease-indent" : (0,
                c.getDefaultKeyBinding)(e)
            }
        }, {
            key: "handleKeyCommand",
            value: function(e) {
                var t = "code" === e || "underline" === e;
                return !t && ("write-edit" === e ? (this.props.toggleWriteEdit(),
                !0) : "show-url-input" === e ? (this.props.turnOnURLInput(),
                !0) : "decrease-indent" === e ? (this.props.decreaseIndent(this.props.editorState),
                !0) : ("bold" === e || "italic" === e) && (this.props.handleKeyCommand(this.props.editorState, e),
                !0))
            }
        }, {
    ...
    var u = function() {
      ...
      , S = function(e) {
        function t(e) {
            o(this, t);
            var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
            return n.toggleShowMore = n.toggleShowMore.bind(n),
            n.state = {
                showAllStats: !1
            },
            n
            ...
            value: function(e) {
                ...
                return n.filter(function(e) {
                    ...
                    return {
                        value: e[t],
                        name: (0,
                        f.capitalize)("readingSeconds" === t ? "reading time" : t)
                    }
                }).map(function(e) {
                    return m(e)
                })
    ...
    var u = function() {
      ...
      , h = function(e) {
        function t(e) {
            o(this, t);
            var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
            return n.onHover = n.onHover.bind(n),
        ...
        u(t, [{
            ...
            value: function(e) {
                ...
                }, 500) : r ? (this.resetTimer(),
                this.setState(e.options)) : this.setState(e.options)
            }
        }, {
            key: "onHover",
            value: function() {
...
, function(e, t, n) {
    ...
    var r = n(4)
      ...
      , i = function(e, t) {
        return (0,
        r.assoc)("editorState", (0,
        r.prop)("editorState", t))(e)
    }
      , a = (0,
    r.over)((0,
    r.lensProp)("editMode"), (0,
    r.ifElse)((0,
    r.equals)("edit"), (0,
    r.always)("write"), (0,
    r.always)("edit")))
    ...
    function i() {
        ...
        return e.map(function(e, t) {
            return new u.ContentBlock({
                ...
                characterList: (0,
                s.List)((0,
                s.Repeat)(u.CharacterMetadata.EMPTY, e.length))
            })
        })
    }
    function a(e) {
        ...
        return i(e, [{
            ...
            value: function(e, t, n) {
                ...
                return t.findEntityRanges(function(e) {
                    return o = e.getEntity(),
                    null !== o && "LINK" === n.get(o).getType()
                }, function(e, t) {
                    r = r.fill("link-" + o, e, t)
                }),
                r
    ...
    var o = n(4)
      ...
      , g = {
        highlight: function(e) {
            return l.default.iterateOverSentences(e, this.addHighlightsToSentence.bind(this)),
            e
        },
    ...
    var o = n(60)
      ...
      , y = {
        ...
        buildTree: function(e) {
            var t = this;
            return "word" !== e.type && (e.items = this.buildItems(e),
        ...
        findStringsInSentence: function(e, t, n) {
            ...
            return a.forEach(function(i, u) {
                var s = i.text
                  , l = i.sentenceIndex
                  , c = [s];
                a[u + 1] && a[u + 1].sentenceIndex === l + s.length + 1 && (c.push(s + " " + a[u + 1].text),
                a[u + 2] && a[u + 2].sentenceIndex === l + 1 + c[1].length && (c.push(c[1] + " " + a[u + 2].text),
                a[u + 3] && a[u + 3].sentenceIndex === l + 1 + c[2].length && c.push(c[2] + " " + a[u + 3].text))),
            ...
            var n = "Connect(" + u(e) + ")"
              , r = function(r) {
                function u(e, t) {
                    ...
                    (0,
                    _.default)(a.store, 'Could not find "store" in either the context or ' + ('props of "' + n + '". ') + "Either wrap the root component in a <Provider>, " + ('or explicitly pass "store" as a prop to "' + n + '".'));
                ...
                u.prototype.getWrappedInstance = function() {
                    return (0,
                    _.default)(S, "To access the wrapped instance, you need to specify { withRef: true } as the fourth argument of the connect() call."),
                ...
                u.prototype.render = function() {
                    ...
                    var f = !0;
                    return f = !!(s || l || t) && this.updateMergedPropsIfNeeded(),
                    !f && i ? i : (S ? this.renderedElement = (0,
                    d.createElement)(e, c({}, this.mergedProps, {
                        ref: "wrappedInstance"
                    })) : this.renderedElement = (0,
                    d.createElement)(e, this.mergedProps),
